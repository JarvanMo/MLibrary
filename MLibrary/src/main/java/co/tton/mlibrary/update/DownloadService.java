...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        BaseApplication.MyToast.show(R.string.download_begin);
        mBuilder.setContentTitle(appName).setSmallIcon(icon);
        String urlStr = intent.getStringExtra(SystemSettings.UpdateParams.APK_DOWNLOAD_URL);
        InputStream in = null;
        ...
        try {
            ...
            // 下载完成
            //	mBuilder.setContentText(getString(R.str)).setProgress(0, 0, false);
            mBuilder.setContentText(getString(R.string.download_success)).setProgress(0, 0, false);
            BaseApplication.MyToast.show(R.string.download_done);
