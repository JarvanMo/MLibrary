...
public class UpdateDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(getArguments().getString(SystemSettings.UpdateParams.APK_UPDATE_CONTENT))
    ...
    private void goToDownload() {
        ...
        intent.putExtra(SystemSettings.UpdateParams.APK_DOWNLOAD_URL, getArguments().getString(SystemSettings.UpdateParams.APK_DOWNLOAD_URL));
