 ...
 */
public abstract class LazyAdapter<E, H extends BaseViewHolder> extends BaseAdapter {
    ...
    public LazyAdapter(Context context, List<E> data, @LayoutRes int layoutResId, Class<H> clazz) {
